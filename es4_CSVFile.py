...
# 2 - Aggiungete i campi al file "shampoo_sales.csv" -> "shampoo_sales2.csv" e gestite gli errori che verranno generati in modo che le linee vengano saltate ma che venga stampato a schermo l'errore
...
class CSVFile():
    ...
    def get_data(self):
        ...
        # Gestisco l'errore se il nome del file è errato/inesistente
        except:
        ...
        # Se il valore può essere convertito in un float lo aggiungo alla lista valori, altrimento lo inserisco nella lista errore
        ...
        print(f'La lista degli elementi che non sono riuscito a convertire è : {error_list}\n\n')
