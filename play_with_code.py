...
class Model():
	...
	#  Definisco un metodo che calcoli la media degli incrementi di una lista
...
class IncrementModel(Model):
	...
	def total(self):
		...
		increment_total_months = self.dataset[-1] + self.compute_avg_increment(self.dataset) 
